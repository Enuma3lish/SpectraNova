...
const (
	CategoryService_ListCategories_FullMethodName = "/fenzvideo.v1.CategoryService/ListCategories"
)
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *ListCategoriesRequest, opts ...grpc.CallOption) (*ListCategoriesReply, error) {
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *ListCategoriesRequest) (*ListCategoriesReply, error) {
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fenzvideo.v1.CategoryService",
	...
	Metadata: "fenzvideo/v1/category.proto",
}
